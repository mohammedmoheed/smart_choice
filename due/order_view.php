...
<body>
  <div class="container-fluid">
    ...
    <br>
      ...
      <div class="col-sm-6">
                    ...
                    <hr>
                        ...
                        <!-- <label>image</label> -->
                        <?php //echo "<img src=".$rowedit['image']." width=100px height='100px'>";?>
                        <br>
    ...
    <div class="col-sm-6">
      <hr>
    <h6>The measurment of pant</h6>
    <br>
    <label>Quantity</label>
                                <input type="text" value="<?php echo $rowedit['pquantity'];?>" name="pquantity" id="pquantity" disabled>
                                <!-- <label>image</label> -->
                                <?php //echo "<img src=".$rowedit['paint_image']." width=100px height='100px'>";?>
                                <br>
